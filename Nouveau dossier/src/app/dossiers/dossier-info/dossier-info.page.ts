        ...
        authObs.subscribe(
          resData => {
            if (+resData.code === 200) {
              ...
              this.cdaObj = this.dataDossier.CDA;
              this.cdrObj = this.dataDossier.CDR;
              ...
              // console.log('alteplase >>>>> ::::', this.protocoleObj['alteplase']);
              // console.log('tenecteplase >>>>> ::::', this.protocoleObj['tenecteplase']);
              //  this.protocoleObj =[];
